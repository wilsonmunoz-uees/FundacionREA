<?php
/**
 * plantillas/consentimiento_proveedor.php
 * -----------------------------------------------------------------------------
...
<p>
  Esta declaración se refiere a los datos personales asociados al proveedor
  <strong><?= $e($datos['titular'] ?? '') ?></strong>, identificado con
  <?= $e(mb_strtolower((string)($datos['documento'] ?? 'documento'), 'UTF-8')) ?>
  N.º <strong><?= $e($datos['identificacion'] ?? '') ?></strong>.
</p>

<p>
  Comprende los datos de la persona natural de contacto y los datos recabados con ocasión de la
  relación comercial: identificación, contacto, facturación y cumplimiento contractual.
</p>
