<?php
/**
 * plantillas/consentimiento_estudiante.php
 * -----------------------------------------------------------------------------
...
<p>
  Esta declaración se refiere a los datos personales del/de la estudiante
...
<?php if (!empty($datos['representante'])): ?>
  <p>
    Usted la suscribe en calidad de <strong>representante</strong> del/de la estudiante, condición
    que consta registrada en la institución a nombre de
    <strong><?= $e($datos['representante']) ?></strong>.
  </p>
<?php endif; ?>
